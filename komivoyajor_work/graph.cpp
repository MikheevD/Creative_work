...
void Graph::createTabWidget(const QRectF &rect){
    ...
    tab->setGeometry(sceneRect.left() + 1, sceneRect.bottom(), sceneRect.width() + 1, sceneRect.height()/9);
    ...
    addVertexButton->setMaximumSize(QSize(320, 60));
    addVertexButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: Black;} "
                                   "QPushButton:pressed{background-color: Green;} "
                                   "QPushButton{ background-color: Red;  border-style: outset;border-width: 3px;border-radius: 30px; padding: 6px;border-color: beige;font: bold 16px;min-width: 14em;}");
    ...
    eraseVertexButton->setMaximumSize(QSize(320, 60));
    eraseVertexButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: Black;} "
                                     "QPushButton:pressed{background-color: Green;} "
                                      "QPushButton{ background-color: Red;  border-style: outset;border-width: 3px;border-radius: 30px; padding: 6px;border-color: beige;font: bold 16px;min-width: 14em;}");
    ...
    addEdgeButton->setMaximumSize(QSize(170, 60));
    addEdgeButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: Black;} "
                                 "QPushButton:pressed{background-color: Green;} "
                                  "QPushButton{ background-color: Red;  border-style: outset;border-width: 3px;border-radius: 30px; padding: 6px;border-color: beige;font: bold 16px;min-width: 14em;}");
    ...
    updateWeightButton->setMaximumSize(QSize(170, 60));
    updateWeightButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: Black;} "
                                      "QPushButton:pressed{background-color: Green;} "
                                       "QPushButton{ background-color: Red;  border-style: outset;border-width: 3px;border-radius: 30px; padding: 6px;border-color: beige;font: bold 16px;min-width: 14em;}");
    ...
    eraseEdgeButton->setMaximumSize(QSize(170, 60));
    eraseEdgeButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: Black;} "
                                   "QPushButton:pressed{background-color: Green;} "
                                  "QPushButton{ background-color: Red;  border-style: outset;border-width: 3px;border-radius: 30px; padding: 6px;border-color: beige;font: bold 16px;min-width: 14em;}");
    ...
    functionButton->setMaximumSize(QSize(140, 60));
    functionButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: Black;} "
                                  "QPushButton:pressed{background-color: Green;} "
                                 "QToolButton{border-style: outset;border-width: 3px;border-radius: 30px; padding: 6px;border-color: beige; background-color: Red;font: bold 16px}");
    ...
    resetButton->setMaximumSize(QSize(140, 60));
    resetButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: Black;} "
                               "QPushButton:pressed{background-color: Green;} "
                               "QPushButton{ background-color: Red;  border-style: outset;border-width: 3px;border-radius: 30px; padding: 6px;border-color: beige;font: bold 16px}");
    ...
    clearButton->setMaximumSize(QSize(140, 60));
    clearButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: Black;} "
                               "QPushButton:pressed{background-color: Green;} "
                               "QPushButton{ background-color: Red;  border-style: outset;border-width: 3px;border-radius: 30px; padding: 6px;border-color: beige;font: bold 16px}");
    ...
    functionsInfoButton->setMaximumSize(QSize(220, 60));
    functionsInfoButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: Black;} "
                                       "QPushButton:pressed{background-color: Green;} "
                                        "QPushButton{ background-color: Red;  border-style: outset;border-width: 3px;border-radius: 30px; padding: 6px;border-color: beige;font: bold 16px}");
    ...
    matrixInfoButton->setMaximumSize(QSize(220, 60));
    matrixInfoButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: Black;} "
                                    "QPushButton:pressed{background-color: Green;} "
                                    "QPushButton{ background-color: Red;  border-style: outset;border-width: 3px;border-radius: 30px; padding: 6px;border-color: beige;font: bold 16px}");
    ...
    findShortPath->setMaximumSize(QSize(120, 60));
    findShortPath->setStyleSheet("QPushButton:selected, QPushButton:hover{color: Black;} "
                                 "QPushButton:pressed{background-color: Green;} "
                                 "QPushButton{ background-color: Red;  border-style: outset;border-width: 3px;border-radius: 30px; padding: 6px;border-color: beige;font: bold 16px;min-width: 14em;}");
    ...
    clearLineButton->setMaximumSize(QSize(120, 60));
    clearLineButton->setStyleSheet("QPushButton:selected, QPushButton:hover{color: Black;} "
                                   "QPushButton:pressed{background-color: Green;} "
                                   "QPushButton{ background-color: Red;  border-style: outset;border-width: 3px;border-radius: 30px; padding: 6px;border-color: beige;font: bold 16px;min-width: 14em;}");
...
void Graph::travellingSalesman(int vertexIndex,QLineEdit *line)
{
    ...
    vertexList[vertexIndex]->setColor("Greeb");
